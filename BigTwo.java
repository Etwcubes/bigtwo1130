            ...
            switch (cc) {
                ...
                case 5:
                {
                    ...
                    for(int i = 0; i < player2.getCardCount(); i++){
                        if (player2.getCard(i).getValue() > player2biggestcard1){
                            player2biggestcard1 = player2.getCard(i).getValue();
                        }
                    }

                    if (player1biggestcard1 < player2biggestcard1) {
...
////player 1 turn ends
            ...
            switch (cc2) {
                ...
                case 2:
                    ...
                    firstCard--;
                    secondCard--;
                    p2cardvalue = firstCard;
                    if (p2cardvalue > p1cardvalue){
                        System.out.print("Player 2 used the card " + player1.getCard(firstCard) + "& " + player1.getCard(secondCard) + "\r\n");
                        player2.removeCard(firstCard);
                        player2.removeCard(secondCard);
                    }break;
                case 5:
                {
                    int player1biggestcard2 = 0;
                    int player2biggestcard2 = 0;
                    for (int i = 0; i < player1.getCardCount(); i++){
                        if (player1.getCard(i).getValue() > player1biggestcard2){
                            player1biggestcard2 = player1.getCard(i).getValue();
                        }
                    }
                    for(int i = 0; i < player2.getCardCount(); i++){
                    ...
                    if (player2biggestcard2 < player1biggestcard2) {
